<?php include_once $_SERVER['DOCUMENT_ROOT'].'/aboutme/templates/public/inc/header.php'?>
          ...
          <div class="col-md-8 col-md-offset-2">
            <div class="center">
              <div class="img-relative photo">
                <img alt="My Photo" src="templates/public/images/me.jpg">
              </div>
              <div class="img-relative photo">
                <img alt="My Photo" src="templates/public/images/me2.jpg">
              </div>
              <div class="img-relative photo">
                <img alt="My Photo" src="templates/public/images/me3.jpg">
              </div>
              <div class="img-relative photo">
                <img alt="My Photo" src="templates/public/images/me4.jpg">
              </div>
            </div>

            <div class="description">
              <div class="text">
                <p>I Am Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec efficitur ipsum. In id feugiat nibh. Proin viverra metus vel orci eleifend eleifend. Duis eu magna ac nisi accumsan viverra ac eu massa. Aenean fermentum at mi vel suscipit. Aenean hendrerit lorem vel magna lobortis volutpat. Proin auctor convallis quam sit amet ullamcorper.</p>
              </div>
            </div>
    ...
    <section class="counter" style="background: url(templates/public/images/banner2.jpg) center; background-size: cover; background-attachment: fixed;">
        ...
        <div class="container">
          <div class="carousel-inner">
            <div class="item active">
              <div class="photo">
                <img src="templates/public/images/person1.jpg" alt="Testimonial">
              </div>
              <div class="text">
            ...
            <div class="item">
              <div class="photo">
                <img src="templates/public/images/person2.jpg" alt="Testimonial">
              </div>
              <div class="text">
                " Nullam rhoncus suscipit mauris, sit amet suscipit nisi eleifend et. Lorem Ipsum dolor sit amet, consectetur adipiscing elit. Nullam rhoncus suscipit mauris, sit amet suscipit nisi   eleifend et consectetur adipiscing elit. "
              </div>
   ...
   <?php include_once $_SERVER['DOCUMENT_ROOT'].'/aboutme/templates/public/inc/footer.php'?>