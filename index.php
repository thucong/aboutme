<?php include_once $_SERVER['DOCUMENT_ROOT'].'/aboutme/templates/public/inc/header.php'?>
<?php include_once $_SERVER['DOCUMENT_ROOT'].'/aboutme/utils/DBConnectionUtil.php'?>
<?php include_once $_SERVER['DOCUMENT_ROOT'].'/aboutme/utils/ConstantUtil.php'?>
<?php 
	//tổng số dòng
	//$queryTSD = "SELECT count(*) AS TSD FROM tintuc";
...
?>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
			...
			<?php
				...
				//$sql = "SELECT picture FROM me ";
				//$result = $mysqli ->query($sql);
				//while($arMe = mysqli_fetch_assoc($result)){
			?>
              <div class="img-relative photo">
                <img alt="" src="aboutme/templates/public/images/<?php echo $arMe['picture'];?>">
              </div>
				<?php //}?>
            </div>
            ...
            <div class="description">
             <!-- <div class="text">
                <p>Tôi đang học tại Trường đại học Bách Khoa Đà Nẵng. Tôi muốn trở thành một Web Developer</p>
              </div>-->
            </div>
    ...
    <section class="counter" style="background: url(aboutme/templates/public/images/ut4.jpg) center; background-size: cover; background-attachment: fixed;">
          ...
          <div class="item col-md-4 col-sm-6 col-xs-12 webdesign">
            <a href="duan.php">
              <div class="content">
                ...
                <div class="image">
                  <img src="aboutme/templates/public/images/work1.jpg" alt="Portfolio image">
                </div>
              </div><!--/.content -->
            </a>
          </div><!--/.item -->
          ...
          <div class="item col-md-4 col-sm-6 col-xs-12 webdevelopment">
            <a href="duan.php">
              <div class="content">
                ...
                <div class="image">
                  <img src="aboutme/templates/public/images/work2.jpg" alt="Portfolio image">
                </div>
              </div><!--/.content -->
            </a>
          </div><!--/.item -->
          ...
          <div class="item col-md-4 col-sm-6 col-xs-12 webdesign">
            <a href="duan.php">
              <div class="content">
                ...
                <div class="image">
                  <img src="aboutme/templates/public/images/work3.jpg" alt="Portfolio image">
                </div>
              </div><!--/.content -->
            </a>
          </div><!--/.item -->
          ...
          <div class="item col-md-4 col-sm-6 col-xs-12 webdevelopment">
            <a href="duan.php">
              <div class="content">
                ...
                <div class="image">
                  <img src="aboutme/templates/public/images/work4.jpg" alt="Portfolio image">
                </div>
              </div><!--/.content -->
            </a>
          </div><!--/.item -->
          ...
          <div class="item col-md-4 col-sm-6 col-xs-12 webdesign">
            <a href="duan.php">
              <div class="content">
                ...
                <div class="image">
                  <img src="aboutme/templates/public/images/work5.jpg" alt="Portfolio image">
                </div>
              </div><!--/.content -->
            </a>
          </div><!--/.item -->
          ...
          <div class="item col-md-4 col-sm-6 col-xs-12 webdevelopment">
            <a href="duan.php">
              <div class="content">
                ...
                <div class="image">
                  <img src="aboutme/templates/public/images/work6.jpg" alt="Portfolio image">
                </div>
              </div><!--/.content -->
            </a>
          </div><!--/.item -->
      ...
      <div class="container">
        <div class="col-md-12">
          <div class="show-more text-center">
            <a href="portfolio-list.php" class="def-btn">Show More</a>
          </div>
        </div>
      </div>
    ...
    <section class="testimonial text-center" id="testimonial" style="background: url(templates/public/images/banner3.jpg) center; background-size: cover; background-attachment: fixed;">
      <div class="overlay"></div>
        ...
        <div class="container">
          <div class="carousel-inner">
            <div class="item active">
              <div class="photo">
                <img src="aboutme/templates/public/images/ut1.jpg" alt="Testimonial">
              </div>
              <div class="text">
            ...
            <div class="item">
              <div class="photo">
                <img src="aboutme/templates/public/images/person2.jpg" alt="Testimonial">
              </div>
              <div class="text">
                " Nullam rhoncus suscipit mauris, sit amet suscipit nisi eleifend et. Lorem Ipsum dolor sit amet, consectetur adipiscing elit. Nullam rhoncus suscipit mauris, sit amet suscipit nisi   eleifend et consectetur adipiscing elit. "
              </div>
    ...
    <section class="twitter-feed" style="background: url(templates/public/images/banner4.jpg) center; background-size: cover; background-attachment: fixed;">
      <div class="overlay"></div>
    ...
    <section class="journal bg-section" id="news">
      <div class="container">
        ...
        <?php 
			$sql = "SELECT * FROM tintuc INNER JOIN chucvu WHERE tintuc.id_chucvu = chucvu.id_chucvu ORDER BY id_tintuc DESC LIMIT {$offset},{$row_count}";
			$result = $mysqli->query($sql);
			while($arr = mysqli_fetch_assoc($result)){
				$name = $arr['name'];
				$chucvu = $arr['chucvu'];
				$comment = $arr['comment'];
				$preview = $arr['preview_text'];
		?>
          ...
          <article class="col-md-4 col-sm-6 masonry wow animated fadeIn">
            <div class="journal-content">
              <div class="detail">
                ...
                <div class="title"><a href="congnghe.php"><h3><?php echo $name;?></h3></a></div>
                <div class="info">
                  <i class="pe-7s-user"></i><a href="#"><?php echo $chucvu;?></a>  <i class="pe-7s-comment"></i> <a href="#"><?php echo $comment;?> Comments</a>
                </div>
                <div class="text"><?php echo $preview;?></div>
      ...
      <div class="container">
        <div class="col-md-12">
          <div class="show-more text-center">
            <a href="showmore.php" class="def-btn">Show More</a>
          </div>
        </div>
      </div>
    ...
    <section class="clients">
      <div class="container">
        ...
        <div id="clients" class="clients-logo owl-theme wow animated fadeIn">
          <div class="item">
            <a href="#"><img src="templates/public/images/client1.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client2.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client3.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client4.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client5.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client6.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client7.png" alt="clients"></a>
          </div>
          <div class="item">
            <a href="#"><img src="templates/public/images/client8.png" alt="clients"></a>
          </div>
        </div>
      </div><!--/.container -->
    </section><!--/.clients -->
      ...
      <div class="container"> 
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="footer-form">
            <form role="form" class="contact" action="index.php" method="post">
              ...
              <div class="col-md-12 textarea-container wow animated fadeInUp" data-wow-delay="0.2s">
                <textarea class="form-control" placeholder="Your Message Here" name="info"></textarea>
              </div>
              <div class="col-md-12 button-container wow animated fadeInUp" data-wow-delay="0.2s">
                <input type="submit" class="submit-btn def-btn" value="Send Message" name="submit">
              </div>
            </form>
          </div><!--/.footer-form -->
        </div>
